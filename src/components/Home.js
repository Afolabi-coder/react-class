...
function Home(props) {
  const postList = props.posts.slice(0, 3).map((post) => {
    return (
      <div>
        <CardList {...post} />
      </div>
        ...
        <div className="row">
          ...
          <div className="col-md-6">
            ...
            <p className="lead mt-5">
              ...
              magni? Aperiam cum doloribus nam alias amet. Lorem ipsum dolor sit
              amet consectetur adipisicing elit. Distinctio ipsa praesentium
              itaque similique, architecto in obcaecati asperiores saepe optio
              doloremque aut mollitia ipsum magni? Aperiam cum doloribus nam
              alias amet.
            </p>
          ...
          <div className="col-md-4">
            <div className="card shadow">
              ...
              <div className="card-body">
                ...
                impedit commodi odit nisi. Illo repellat modi similique laborum
                iusto aut labore corrupti?
              </div>
            </div>
          </div>
          <div className="col-md-4">
